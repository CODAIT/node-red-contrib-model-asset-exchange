    ...
    it('should handle get_metadata()', function (done) {
        var flow = [
            { id: 'n1', type: 'scene-classifier', name: 'scene-classifier',
                ...
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'scene-classifier-service', host: 'https://max-scene-classifier.codait-prod-41208c73af8fca213512856c7a09db52-0000.us-east.containers.appdomain.cloud' },
            { id: 'n3', type: 'helper' }
        ];
        helper.load(node, flow, function () {
