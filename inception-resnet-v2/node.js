...
module.exports = function (RED) {
    ...
    RED.nodes.registerType("inception-resnet-v2", ModelAssetExchangeServerNode);
    ...
    RED.nodes.registerType("inception-resnet-v2-service", ModelAssetExchangeServerServiceNode, {
        credentials: {
            temp: { type: "text" }
        }
    });
